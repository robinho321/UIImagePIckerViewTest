...
let albumName = "Panda Cold"            //App specific folder name

class ColdCollectionViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
...
//    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell{
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "cell", for: indexPath) as? myColdCell
    ...
    override func setEditing(_ editing: Bool, animated: Bool) {
        ...
        if let indexPaths = collectionView?.indexPathsForVisibleItems {
            for indexPath in indexPaths {
                if let cell = collectionView?.cellForItem(at: indexPath) as? myColdCell {
...
extension ColdCollectionViewController: myColdCellDelegate
{
...
//extension ColdCollectionViewController : UICollectionViewDelegateFlowLayout {
//    //1
