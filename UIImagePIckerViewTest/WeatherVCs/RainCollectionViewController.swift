...
let albumName4 = "Panda Rain"            //App specific folder name

class RainCollectionViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        fetchOptions.predicate = NSPredicate(format: "title = %@", albumName4)
        ...
        if let first_Obj:AnyObject = collection.firstObject{
            ...
            //create the folder
            NSLog("\nFolder \"%@\" does not exist\nCreating now...", albumName4)
            PHPhotoLibrary.shared().performChanges({
                let request = PHAssetCollectionChangeRequest.creationRequestForAssetCollection(withTitle: albumName4)
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell{
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "cell", for: indexPath) as? myRainCell
    ...
    override func setEditing(_ editing: Bool, animated: Bool) {
        ...
        if let indexPaths = collectionView?.indexPathsForVisibleItems {
            for indexPath in indexPaths {
                if let cell = collectionView?.cellForItem(at: indexPath) as? myRainCell {
...
extension RainCollectionViewController: myRainCellDelegate
{
