...
let albumName5 = "Panda Lightning"            //App specific folder name

class LightningCollectionViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell{
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "cell", for: indexPath) as? myLightningCell
    ...
    override func setEditing(_ editing: Bool, animated: Bool) {
        ...
        if let indexPaths = collectionView?.indexPathsForVisibleItems {
            for indexPath in indexPaths {
                if let cell = collectionView?.cellForItem(at: indexPath) as? myLightningCell {
...
extension LightningCollectionViewController: myLightningCellDelegate
{
